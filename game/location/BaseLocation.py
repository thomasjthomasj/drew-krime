...
class BaseLocation(object):
    ...
    def buildPlatforms(self):
        ...
        platform1 = Platform(self, platform1_pos, (153,25,190), 400, 50)
        platform2_pos = (500, dimensions[1] - 30)
        platform2 = Platform(self, platform2_pos, (200,155,19), 300, 20)
        platform3_pos = (dimensions[0] - 80, dimensions[1] - 40)
        platform3 = Platform(self, platform3_pos, (20,155,19), 85, 20)
